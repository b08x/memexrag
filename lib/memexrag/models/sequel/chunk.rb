...
class Chunk < Sequel::Model(PGConnect.instance.db[:chunks]) # Explicitly connect to the 'documents' table
  ...
  set_dataset PGConnect.instance.db[:chunks] unless table_name == :chunk_records
